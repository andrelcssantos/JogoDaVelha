...
public class JogoMacVsMac extends javax.swing.JFrame {

	UtilMac util = new UtilMac();
	...
	private void initComponents() {
		...
		setTitle("Jogo da Velha Maquina VS Maquina");
		setResizable(false);
		...
		jLabel1.setText("Jogo da Velha Maquina VS Maquina");
	...
	private void aguardaTempo(long tempo) {
		long inicio = System.currentTimeMillis();
		while ((inicio + (tempo * 1000)) > System.currentTimeMillis()) {
		}
		return;
	}
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(JogoMacVsMac.class.getName())
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new JogoMacVsMac().setVisible(true);
			}
		});
	}
